...
import { CustomerMessageDetailsPage } from '../customer-message-details/customer-message-details';
import { MartNewMessagePage } from '../mart-new-message/mart-new-message';



@Component({
  selector: 'page-customer-messages',
  templateUrl: 'customer-messages.html',
})
export class CustomerMessagesPage {
  userid: any;
  UDetails: any;
  msg: string;
  msgSegment: any;
  ...
  goToInboxDetails(messageid) {
    ...
    this.navCtrl.push(CustomerMessageDetailsPage, { messageid, messagetype });
  }
